...
Then all the operations with respect to $\w$, such as those in \eref{spectral-decomposition}, \eref{numerical-integration}, and \eref{probabilistic-moments}, should be undertaken elementwise.
...
In what follows, we shall apply the probabilistic analysis developed in this section to a number of concrete problems: temperature analysis (\sref{temperature-analysis}), reliability analysis (\sref{reliability-analysis}), and reliability optimization (\sref{reliability-optimization}).
