...
\updated{Needless to say, Algorithm~X is problem specific and has a crucial impact of the performance of the whole procedure presented in this section: any modeling errors inherent to this algorithm can propagate to the output of the uncertainty analysis.
