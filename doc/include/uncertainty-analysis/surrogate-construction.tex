...
In such a case, we shall consider $\w$ as a row vector with an appropriate number of elements.
...
Further, in \eref{quantity-evaluation}, $\coefficient{\vw}$ and $\vw$ to be treated as matrices, and $\w_i$ as a row vector.
\end{remark}
