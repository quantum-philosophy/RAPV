The technique used to solve the thermal model in \eref{thermal-model} belongs to the family of so-called exponential integrators \cite{hochbruck2010}, which are known to have good stability properties.
