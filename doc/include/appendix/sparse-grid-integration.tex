...
\end{equation}
The quadrature should be chosen to be suitable for integration with respect to the standard Gaussian measure $\d\distribution_\z$ in \xeref{orthogonal-projection}, which is not explicitly present in \xeref{non-intrusive-orthogonal-projection} as it is taken into account by the weights.
