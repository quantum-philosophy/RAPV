...
Since any covariance matrix is real and symmetric, $\mCov_\z$ admits the eigendecomposition as $\mCov_\z = \mEDV \mEDL \mEDV^T$ (see \sref{thermal-model} for the notation).
