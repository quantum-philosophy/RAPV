...
Since any correlation matrix is real and symmetric, $\mCorr_\h$ admits the eigendecomposition: $\mCorr_\h = \mEDV \mEDL \mEDV^T$ (see \sref{thermal-model} for the notation).
