...
We model such parameters using \rvs\ and denote them by the random vector $\vu(\o) = (\u_i(\o))_{i = 1}^\nparams$.
...
\begin{itemize}
  \item Extend the probabilistic temperature analysis to include the \dss\ scenario under the uncertainty due to process variation specified by $\vu(\o)$.
