...
Now we turn to the stochastic scenario, that is, $\vu$ is no longer deterministic but random, and apply \aref{surrogate-construction} to one particular quantity of interest $\w$.
