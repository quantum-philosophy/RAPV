...
The preliminaries are given in \sref{preliminaries}.
...
In \sref{experimental-results}, the experimental results are reported and discussed.
\sref{conclusion} concludes the paper.
The appendix (\xref{temperature-solution}--\xref[]{numerical-integration}) contains a set of supplementary materials with discussions on certain aspects of our solutions.
