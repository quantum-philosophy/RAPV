...
The primary quantity to pay attention to is the number of \rvs\ $\nvars$ preserved after the reduction procedure described in \sref{parameter-preprocessing} and \xref{model-order-reduction}.
...
The magnitude of reduction is solely determined by the correlation patterns assumed (see \sref{parameter-preprocessing}) and the floorplans of the considered platforms.
