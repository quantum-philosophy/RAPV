...
The corresponding probabilistic model is the one described in \sref{parameter-preprocessing}, and the model order reduction is set to preserve 95\% of the variance of the problem (see also \xref{model-order-reduction}).
