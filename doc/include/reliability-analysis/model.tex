...
The lifetime is the time span until the system experiences a fault after which the system no longer meets the requirements imposed on this system.
...
To give an example, $\survival_\T = \survival_{\T_1} (1 - (1 - \survival_{\T_2})^2)$ can represent a system with two components wherein the second one has a hot spare.
